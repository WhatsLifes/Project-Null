...
public class Stage2ElevatorButton : MonoBehaviour, stage2_InteractableScript
{
    ...
    private IEnumerator HandleButtonPress()
    {
        ...
        bool conditionMet = Stage2ProgressManager.Instance.sonPhotoPickedUp;

        // ❌ Not ready
        if (!conditionMet)
        {
            Debug.Log("Son photo NOT picked up — cannot open elevator.");
        ...
        // ✅ Ready
        Debug.Log("Son photo picked up — opening elevator!");
